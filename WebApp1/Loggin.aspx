<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Loggin.aspx.cs" Inherits="WebApp1.Loggin" %>
            ...
            <div class="grilla">
                ...
                <div class="columna">
                    <div class="2columna">
                        ...
                        <br />
                        <asp:TextBox ID="txtClave" TextMode="Password" runat="server" CssClass="txt" placeholder="Contraseña"></asp:TextBox>
